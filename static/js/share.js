...
/** Added for My_DentalPlan **/
function returnpage(mode)
{
    if(mode=="login")
	    window.location.replace('/my_dentalplan/default/member_login')
    else if(mode == "register")
	    window.location.replace('/my_dentalplan/default/member_register')
    else
	    window.location.replace('/my_dentalplan/default/member_register')
